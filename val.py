...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config", type=str, default="configs/validation/validation_scalable.yaml"
    )
    parser.add_argument("--pretrain_ckpt", type=str, default="demo.ckpt")
    ...
    val_dataset = {
        ...
        transform=WaymoTargetBuilder(
            config.Model.num_historical_steps, config.Model.decoder.num_future_steps
        ),
    )
    ...
    if args.pretrain_ckpt == "":
        ...
        model.load_params_from_file(
            filename=args.pretrain_ckpt, logger=logger, to_cpu=True
        )
